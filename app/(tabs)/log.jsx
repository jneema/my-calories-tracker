...
import { searchFood } from "../../apis/usda";
    ...
    >
      ...
      >
          ...
          <>
            <View className="mt-5">
              ...
              <View className="flex-row mt-4 gap-3">
                ...
                <TouchableOpacity
                  className="flex-1 flex-col items-center bg-[#0891b2] rounded-xl p-4"
            ...
            {selectedFood && (
              <View className="mt-5 bg-white rounded-xl p-4 shadow-sm">
                ...
                <TouchableOpacity
                  onPress={() =>
                    addToMeal(selectedMeal, selectedFood, quantity)
                  }
        ...
        <AddFoodModal
          ...
          onSave={(newFood) => {
            addFoodToMeal(newFood); // Add to your mealLog state
          }}
        />
      </ScrollView>
    </SafeAreaView>
